...
Nella prescrizione della scheda, MAX identifica le singole serie a cedimento: checkbox numerate e comando Tutte. Le serie non selezionate mantengono l’intervallo numerico; se sono tutte MAX, i campi min/max restano disabilitati e conservano l’intervallo per un successivo ripristino. Il riepilogo indica quali serie sono MAX e l’obiettivo dell’allenamento segue la serie selezionata. I risultati restano numerici: senza uno storico, la serie MAX parte con il campo ripetizioni vuoto. Lo storico affianca il piccolo indicatore MAX al numero della serie, mantenendo il conteggio effettivamente eseguito.
